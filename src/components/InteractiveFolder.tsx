      ...
      >
        ...
        >
          ...
          {displayItems.map((item, i) => (
            ...
            >
              {item || (
                <div className="w-full h-full p-2 flex flex-col gap-1.5 opacity-20 text-black">
          ...
          {/* Full Width Label (Avoids Clip Path) */}
          {label && (
            <motion.div 
            ...
            >
              <div className="text-white text-[10px] md:text-xs font-bold tracking-widest whitespace-nowrap px-2 font-mono uppercase">
                {label}
              </div>
            </motion.div>
          )}
